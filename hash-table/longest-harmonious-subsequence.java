class Solution {
    public int findLHS(int[] nums) {
        ...
        // We go through all the numbers in the nums array... 🚶‍♀️
        for (int num : nums) {
...
int maxLength = 0;
        ...
        // Going through all the unique numbers in our frequencyMap map... 🗺️
        for (int num : frequencyMap.keySet()) {
// ...and check if there is a number in the map that is 1 higher than the current one. 🤔
            if (frequencyMap.containsKey(num + 1)) {
                // If we found the number + 1, it means that we have a "harmonious pair"! 👯‍♂️
                ...
                // Update the maximum length if this pair is steeper than the previous ones. 🏆
